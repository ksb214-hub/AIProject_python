...
| Sprint | 작업 항목 | 설명 | 상태 |
| ------ | ------ | ------ | ------ |
| Sprint 1 | 데이터 수집 | 레시피 크롤링 및 데이터 확보 | 완료 |
| Sprint 1 | 데이터 가공 | DataCleaner 기반 텍스트 정제 | 완료 |
| Sprint 1 | 데이터 저장 | SQLite DB 저장 및 관리 | 완료 |
| Sprint 2 | 챗봇 생성 | RecipeChatBot 구현 | 완료 |
| Sprint 2 | AI 기반 추천 시스템 | 재료 기반 레시피 추천 | 완료 |
| Sprint 2 | 맞춤형 트렌드 추천 | 페르소나 기반 추천 | 완료 |

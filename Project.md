...
| Sprint | 작업 항목 | 설명 | 상태 |
| ------ | ------ | ------ | ------ |
| Sprint 1 | 데이터 수집 | 레시피 크롤링 및 데이터 확보 | ⏳ 진행중 |
| Sprint 1 | 데이터 가공 | DataCleaner 기반 텍스트 정제 | 완료 |
| Sprint 1 | 데이터 저장 | SQLite DB 저장 및 관리 | ⏳ 진행중 |
| Sprint 2 | 챗봇 생성 | RecipeChatBot 구현 | ⏳ 진행중 |
| Sprint 2 | AI 기반 추천 시스템 | 재료 기반 레시피 추천 | ⏱ 예정 |
| Sprint 2 | 맞춤형 트렌드 추천 | 페르소나 기반 추천 | ⏱ 예정 |
| Sprint 3 | 데이터 시각화 | 재료 및 가격 데이터 시각화 | ⏱ 예정 |
| Sprint 3 | 음성 인식 검색 | 음성 기반 레시피 검색 | ⏱ 예정 |
| Sprint 3 | 이미지 기반 필터링 | 음식 이미지 기반 추천 | ⏱ 예정 |

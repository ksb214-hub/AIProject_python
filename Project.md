...
목표  
레시피 데이터를 수집하고, 가공하여 데이터베이스에 저장하는 **기본 데이터 인프라 구축**

주요 작업

- **데이터 수집**
  - 레시피 사이트 크롤링
  - 레시피 제목 / URL / 재료 / 조리 단계 수집
  - Selenium + BeautifulSoup 기반 수집
...
### Sprint 2 : 추천 및 챗봇 시스템 구축

목표  
> 수집된 데이터를 활용하여 **사용자와 대화 가능한 요리 챗봇 및 추천 시스템 구축**
...
- **AI 기반 추천 시스템**
  - 사용자가 입력한 재료 기반 레시피 추천
  - 유사 레시피 검색 알고리즘

- **맞춤형 트렌드 추천**
  - 사용자 페르소나 적용
  - 1인 가구 / 다이어트 / 초보 요리 등 맞춤 추천
